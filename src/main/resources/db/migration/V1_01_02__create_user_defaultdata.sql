INSERT INTO `permission` (id, name, description)  VALUES (1, 'admin',                      'All Operation');
INSERT INTO `permission` (id, name, description)  VALUES (2, 'league.admin',               'League Admin');
INSERT INTO `permission` (id, name, description)  VALUES (3, 'league.user',                'League User');
